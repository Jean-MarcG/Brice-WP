...
<section class="nougatine section" id="nougatine">
  <div class="nougatine__container container grid">
    <div class="nougatine__data">
      <span class="section__subtitle">
        Nos spécialités
      </span>
      <h2 class="section__title nougatine__title">
        <div>
          <img src="/wp-content/uploads/PHOTO-2023-06-28-11-03-39-copie-1.jpg" alt="">
        </div>
        Croquembouche nougatine
      </h2>
      <p class="nougatine__description">
