...
sr.reveal('.coneShaped__data, .croquembouche__data, .customized__data, .numberCake__data', {origin: 'left'})
sr.reveal('.coneShaped__img, .croquembouche__img, .customized__img, .numberCake__img', {origin: 'right'})
